...
const MINIUTES_PER_HOUR: int = 60
...
func set_initial_time() -> void:
	var initial_total_minutes = initial_day * MINUTES_PER_DAY + (initial_hour * MINIUTES_PER_HOUR ) + initial_minute
...
func recalculate_time() -> void:
	...
	var hour: int = int(current_day_minutes / MINIUTES_PER_HOUR)
	var minute: int = int(current_day_minutes % MINIUTES_PER_HOUR)
