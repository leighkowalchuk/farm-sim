...
@export var crop_field_tilemap_layer: TileMapLayer
@onready var player: Player = get_tree().get_first_node_in_group("player")

var corn_plant_scene = preload("res://scenes/objects/plants/corn_plant.tscn")
var tomato_plant_scene = preload("res://scenes/objects/plants/tomato_plant.tscn")
...
func get_cell_under_mouse() -> void:
	mouse_position = crop_field_tilemap_layer.get_local_mouse_position()
	cell_position = crop_field_tilemap_layer.local_to_map(mouse_position)
	cell_source_id = crop_field_tilemap_layer.get_cell_source_id(cell_position)
	local_cell_position = crop_field_tilemap_layer.map_to_local(cell_position)
